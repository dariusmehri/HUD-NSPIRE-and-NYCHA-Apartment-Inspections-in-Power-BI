...
The most important challenge was to convert non-text readable independent inspection reports into text readable data that could be input into Power BI for visualization. Once the data was converted into text,  the next step was to develop algorithms to transform the unstructured data into a structured csv files for visualization. Both of these steps were accomplished using data engineering algorithms in Python.
